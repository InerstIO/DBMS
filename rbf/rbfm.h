...
private:
  ...
  // Update offsets in slotDirs whose offset is larger than afterOffset with delta in page.
  void updateSlotDirOffsets(void* page, unsigned afterOffset, short numSlots, short delta);
